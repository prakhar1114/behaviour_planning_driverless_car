...
class LocalPlanner:
    ...
    def get_goal_state_set(self, goal_index, goal_state, waypoints, ego_state):
        ...
        # goal_x = ...
        # goal_y = ...
        theta_dummy= -ego_state[2]
        goal_x = goal_state_local[0]*cos(theta_dummy) - goal_state_local[1]*sin(theta_dummy)
        goal_y = goal_state_local[0]*sin(theta_dummy) + goal_state_local[1]*cos(theta_dummy)
        # ------------------------------------------------------------------
